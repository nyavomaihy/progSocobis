                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <% }%>
                            <a class="btn btn-warning pull-right" href="<%= lien + "?but=vente/vente-update.jsp&id=" + id%>" style="margin-right: 10px">Update</a>
                            <a class="btn btn-warning pull-right" href="<%= lien + "?but=vente/vente-update-paye.jsp&id=" + id+"&idOrigine=" + request.getParameter("id") + "&montant="+dp.getMontantreste()+"&montant_paye="+dp.getMontantpaye()+"&devise=" + dp.getIdDevise()+"&tiers="+dp.getIdClient()+"&taux="+dp.getTauxdechange()%>" style="margin-right: 10px">Update & Encaisser</a>
                            <% if (dp.getEtat() >= ConstanteEtat.getEtatValider()) {%>
