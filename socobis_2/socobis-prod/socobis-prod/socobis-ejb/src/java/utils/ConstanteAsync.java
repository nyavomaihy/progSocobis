...
public class ConstanteAsync {
    ...
    public static final String API_KEY = "AIzaSyClNqBjlxOsN6H5yaSSwBfKAzUCEuTgBwo";
    public static final String API_URL = "https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent?key=" + API_KEY;
